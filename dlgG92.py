...
class Ui_dlgG92(object):
    def setupUi(self, dlgG92):
        ...
        dlgG92.setWindowModality(QtCore.Qt.WindowModality.ApplicationModal)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/cn5X/images/origine.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.widget = QtWidgets.QWidget(parent=dlgG92)
        ...
        self.widget1 = QtWidgets.QWidget(parent=dlgG92)
        ...
        self.chkDefineX = QtWidgets.QCheckBox(parent=self.widget2)
        self.chkDefineX.setObjectName("chkDefineX")
        self.gridLayout.addWidget(self.chkDefineX, 0, 0, 1, 1)
        self.dsbG92valeurX = QtWidgets.QDoubleSpinBox(parent=self.widget2)
        self.dsbG92valeurX.setMaximumSize(QtCore.QSize(16777215, 23))
        self.dsbG92valeurX.setStyleSheet("color: #bebebe;")
        self.dsbG92valeurX.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.chkDefineY = QtWidgets.QCheckBox(parent=self.widget2)
        self.chkDefineY.setObjectName("chkDefineY")
        self.gridLayout.addWidget(self.chkDefineY, 1, 0, 1, 1)
        self.dsbG92valeurY = QtWidgets.QDoubleSpinBox(parent=self.widget2)
        self.dsbG92valeurY.setMaximumSize(QtCore.QSize(16777215, 23))
        self.dsbG92valeurY.setStyleSheet("color: #bebebe;")
        self.dsbG92valeurY.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.chkDefineZ = QtWidgets.QCheckBox(parent=self.widget2)
        self.chkDefineZ.setObjectName("chkDefineZ")
        self.gridLayout.addWidget(self.chkDefineZ, 2, 0, 1, 1)
        self.dsbG92valeurZ = QtWidgets.QDoubleSpinBox(parent=self.widget2)
        self.dsbG92valeurZ.setMaximumSize(QtCore.QSize(16777215, 23))
        self.dsbG92valeurZ.setStyleSheet("color: #bebebe;")
        self.dsbG92valeurZ.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.chkDefineA = QtWidgets.QCheckBox(parent=self.widget2)
        self.chkDefineA.setObjectName("chkDefineA")
        self.gridLayout.addWidget(self.chkDefineA, 3, 0, 1, 1)
        self.dsbG92valeurA = QtWidgets.QDoubleSpinBox(parent=self.widget2)
        self.dsbG92valeurA.setMaximumSize(QtCore.QSize(16777215, 23))
        self.dsbG92valeurA.setStyleSheet("color: #bebebe;")
        self.dsbG92valeurA.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.chkDefineB = QtWidgets.QCheckBox(parent=self.widget2)
        self.chkDefineB.setObjectName("chkDefineB")
        self.gridLayout.addWidget(self.chkDefineB, 4, 0, 1, 1)
        self.dsbG92valeurB = QtWidgets.QDoubleSpinBox(parent=self.widget2)
        self.dsbG92valeurB.setMaximumSize(QtCore.QSize(16777215, 23))
        self.dsbG92valeurB.setStyleSheet("color: #bebebe;")
        self.dsbG92valeurB.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.chkDefineC = QtWidgets.QCheckBox(parent=self.widget2)
        self.chkDefineC.setObjectName("chkDefineC")
        self.gridLayout.addWidget(self.chkDefineC, 5, 0, 1, 1)
        self.dsbG92valeurC = QtWidgets.QDoubleSpinBox(parent=self.widget2)
        self.dsbG92valeurC.setMaximumSize(QtCore.QSize(16777215, 23))
        self.dsbG92valeurC.setStyleSheet("color: #bebebe;")
        self.dsbG92valeurC.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.widget3 = QtWidgets.QWidget(parent=dlgG92)
        ...
        self.btnSetOriginG92 = QtWidgets.QPushButton(parent=self.widget3)
        ...
        self.btnSetOriginG92.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        self.btnSetOriginG92.setObjectName("btnSetOriginG92")
        self.verticalLayout.addWidget(self.btnSetOriginG92)
        self.btnSetOriginG92_1 = QtWidgets.QPushButton(parent=self.widget3)
        ...
        self.btnSetOriginG92_1.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        self.btnSetOriginG92_1.setObjectName("btnSetOriginG92_1")
        self.verticalLayout.addWidget(self.btnSetOriginG92_1)
        spacerItem1 = QtWidgets.QSpacerItem(18, 33, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        self.verticalLayout.addItem(spacerItem1)
        self.chkAutoclose = QtWidgets.QCheckBox(parent=self.widget3)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=self.widget3)
